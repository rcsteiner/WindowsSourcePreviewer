...
namespace SourcePreview
{
    ...
    public interface IObjectWithSite
    {
        ...
        /// </summary>
        /// <param name="pUnkSite">
        ///                         A pointer to the IUnknown interface pointer of the site managing this object. If
        ///                         NULL, the object should call Release on any existing site at which point the object
